    <?php
    // intermediate.php - Intermediate difficulty game page
    session_start();
    ...
    // Set difficulty and number of bombs for intermediate level
    ...
    <title>Logic Path: Intermediate Mode</title>
    ...
    <div class="container">
        <!-- Header -->
        <header class="header intermediate">
        <h1 class="title">Logic Path</h1>
        <p class="subtitle">Intermediate Mode — 4 Bombs, 2 Lives</p>
        ...
        <section id="start" class="card">
            ...
            <button class="btn intermediate" onclick="startGame('<?php echo $difficulty; ?>', <?php echo $bombs; ?>)">Start Game</button>
